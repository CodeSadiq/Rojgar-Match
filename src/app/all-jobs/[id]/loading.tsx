...
export default function Loading() {
  return (
    <div id="loading-screen" className="fixed inset-0 top-[56px] bg-[#fafaf9] z-[50] flex flex-col items-center justify-center p-6 text-center space-y-8 animate-in fade-in duration-500">
