                ...
                <div className="bg-white border-2 border-gray-200 md:border-gray-200 p-0 md:p-6 shadow-sm md:shadow-sm relative overflow-hidden h-full flex flex-col rounded-lg md:rounded-xl">
                  ...
                  <div className="space-y-4 md:space-y-6 flex-1 flex flex-col p-4 md:p-0">
                    ...
                    {isLoading ? (
                      ...
                      <div className="flex-1 py-8 md:py-20 px-4 md:px-8 bg-gradient-to-br from-emerald-50/40 via-white to-green-50/40 border border-emerald-100/60 p-6 rounded-3xl shadow-[0_15px_40px_rgba(16,185,129,0.05)] md:bg-transparent md:border-0 md:shadow-none md:rounded-none flex flex-col items-center justify-center text-center mx-0 overflow-hidden relative">
                        {/* Background Decor */}
                        <div className="absolute top-0 right-0 w-64 h-64 bg-emerald-500/[0.03] md:bg-navy/[0.02] rounded-full -mr-32 -mt-32 blur-3xl"></div>
                        <div className="absolute bottom-0 left-0 w-64 h-64 bg-emerald-500/[0.03] md:bg-navy/[0.02] rounded-full -ml-32 -mb-32 blur-3xl"></div>

                        <div className="relative z-10 max-w-[800px] w-full">
                          <p className="text-[22px] md:text-[18px] font-black text-emerald-800 md:text-[#0D244D]/90 md:font-bold mb-2 md:mb-3 uppercase md:normal-case tracking-tight md:tracking-normal">
                            Welcome to Rojgar Match
                          </p>

                          <p className="text-[13px] md:text-[19px] text-navy/70 font-medium mb-8 md:mb-12 leading-relaxed max-w-[680px] mx-auto">
                            Find government jobs and updates that match your qualifications.
                          </p>

                          <div className="flex flex-col md:grid md:grid-cols-3 gap-4 md:gap-5 mb-8 md:mb-12 text-left w-full max-w-[480px] md:max-w-none mx-auto">
                            {/* ITEM 1 */}
                            <div className="flex flex-row md:flex-col items-start gap-4 md:gap-3 bg-white/90 border border-emerald-100/70 p-4 rounded-2xl shadow-[0_4px_16px_rgba(16,185,129,0.03)] md:bg-gray-50/80 md:border-gray-100 md:p-5 md:rounded-xl md:shadow-none">
                              <div className="w-10 h-10 md:w-10 md:h-10 bg-emerald-50 text-emerald-600 border border-emerald-100 md:bg-navy/5 md:text-navy md:border-none md:shadow-none rounded-xl flex items-center justify-center flex-shrink-0 shadow-sm">
                              ...
                              <div className="space-y-0.5">
                                <h4 className="text-[12px] md:text-[13px] font-bold text-emerald-800 md:text-navy uppercase tracking-wider">
                                  Eligible Jobs
                                </h4>
                                <p className="text-[11px] text-navy/60 md:text-navy/50 leading-relaxed font-medium">
                          ...
                          <Link
                            href="/login"
                            className="inline-flex items-center justify-center gap-3 w-full md:w-auto px-8 md:px-12 py-3.5 md:py-4 bg-gradient-to-r from-emerald-600 to-green-700 hover:from-emerald-700 hover:to-green-800 md:from-navy md:to-navy md:bg-navy md:hover:bg-[#06142E] text-white text-[11px] md:text-[13px] font-black uppercase tracking-widest transition-all shadow-xl shadow-emerald-600/25 md:shadow-navy/20 rounded-2xl md:rounded-xl no-underline group active:scale-[0.98]"
                          >
